...
class _NouAniversariScreenState extends State<NouAniversariScreen> {
  ...
  */
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(widget.editando ? 'دەستکاریکردن' : 'ڕۆژبوونێکی نوێ'),
        leading: BackButton(
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              TextField(
                textAlign: TextAlign.right,
                decoration: InputDecoration(hintText: 'ناوی باوک'),
                controller: _cognom1Controller,
                textInputAction: TextInputAction.next,
              ),
              TextField(
                textAlign: TextAlign.right,
                decoration: InputDecoration(hintText: 'ناوی باپیر'),
              ...
              Container(
                ...
                child: ElevatedButton.icon(
                  ...
                  label:
                      Text((!widget.editando) ? 'پاشەکەوت کردن' : 'نوێکردنەوە'),
